...
*/
	fprintf( stdout, "%s: Mo=%e MT.xx=%e MT.yy=%e MT.zz=%e MT.xy=%e MT.xz=%e MT.yz=%e\n",
		progname, MoTotal, MT.xx, MT.yy, MT.zz, MT.xy, MT.xz, MT.yz );
...
/*** set and normalize the moment tensor ***/
	...
	x_vector[1] = MT.xx * MoTotal;
	x_vector[2] = MT.yy * MoTotal;
	x_vector[3] = MT.xy * MoTotal;
	x_vector[4] = MT.xz * MoTotal;
	x_vector[5] = MT.yz * MoTotal;
	x_vector[6] = MT.zz * MoTotal;
